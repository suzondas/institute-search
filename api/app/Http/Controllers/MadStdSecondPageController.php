...
//        /*ALIM VOC Students*/
    ...
    public function submitData(Request $request)
    {
        ...
        $dakhilVocStudentData = $data["dakhilVocStudentData"];
        //$hscVocStudent = $data["hscVocStudent"];
        //$alimVocStudentData = $data["alimVocStudentData"];
        ...
        /* saving Dakhilvoc_student_summary */

        try {
            Dakhilvoc_student_summary::where('institute_id', $instId)->delete();
            Dakhilvoc_student_summary::insert($dakhilVocStudentData);
        } catch (\Exception $e) {
            array_push($err, $e);
        }
...
//        }
        ...
        /* saving Alimvoc_student_summary */

//        try {
//            Alimvoc_student_summary::where('institute_id', $instId)->delete();
//            Alimvoc_student_summary::insert($alimVocStudentData);
//        } catch (\Exception $e) {
//            array_push($err, $e);
//        }

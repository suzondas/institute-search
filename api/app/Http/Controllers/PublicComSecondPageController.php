...
class PublicComSecondPageController extends Controller
{
    public function index($inst_id){
        ...
        if ($univ_building_dtls_own->isEmpty()) {
            ...
            foreach ($pubRoomLists as $pubRoomList) {
                $toInsertArrBdt = [];
                $toInsertArrBdt['institute_id'] = $inst_id;
                $toInsertArrBdt['building_type'] = 'OWN';
                $toInsertArrBdt['room_id'] = $pubRoomList['room_id'];
                array_push($toAddRoomData, $toInsertArrBdt);
            }
            try {

    ...
    public function store(Request $request)
    {
        ...
        try {
            Institutes::where('institute_id', $instId)->update([
                ...
                'mojjabid_group'=>$institutes['mojjabid_group'],
                'hifjul_group'=>$institutes['hifjul_group'],
                'mojjabid_mahir_group'=>$institutes['mojjabid_mahir_group'],
                ...
                'technical_branch_type_dak_voc'=>$institutes['technical_branch_type_dak_voc'],
                'technical_branch_type_hscvoc'=>$institutes['technical_branch_type_hscvoc'],
                'technical_branch_type_alim_voc'=>$institutes['technical_branch_type_alim_voc'],
                ...
                'lowest_edu_level'=>$institutes['lowest_edu_level'],

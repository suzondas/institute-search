...
class SnCFifthPageController extends Controller
{
    ...
    public function submitData(Request $request)
    {
        ...
        $studentSummeryColPrevYr = $data["studentSummeryColPrevYr"];
        ...
        /* saving Student_summary_prev_year College */

        try {
            Student_summary_prev_year::wherein('education_level_id', array(31,32,33,34))->where('institute_id', $instId)->delete();
            Student_summary_prev_year::insert($studentSummeryColPrevYr);
        } catch (\Exception $e) {
            array_push($err, $e);
        }

...
class CollegeFifthPageController extends Controller
{
    ...
    public function submitData(Request $request)
    {
        ...
        /* saving technical teacher summaries */
        try {
        ...
        /* saving  teacher qualification summaries */
        try {
        ...
        /* saving  teacher higher education training */
        try {
        ...
        /*Updating Teachers_inservice_trainings table data */
        try {
            Teachers_inservice_trainings::where('id', $teacherInservTr["id"])->update($teacherInservTr);
        } catch (\Exception $e) {
            array_push($err, $e->getMessage());//pushing error to error container
        }


        /*saving teacher_trainig_info table data*/
        try {
        ...
        /*saving data of Teachers_retire_award_infos table */
        try {

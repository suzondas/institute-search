...
class SnCFirstPageController extends Controller
{
    ...
    public function submitData(Request $request)
    {
        ...
        $studentSummeryCol = $data["studentSummeryCol"];
        ...
        /* saving studentSummeryCol */

        try {
            Students_summary::wherein('education_level_id', array(31,32,33,34))->where('institute_id', $instId)->delete();
            Students_summary::insert($studentSummeryCol);
        } catch (\Exception $e) {
            array_push($err, $e);
        }

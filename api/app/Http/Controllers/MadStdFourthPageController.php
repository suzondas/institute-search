...
class MadStdFourthPageController extends Controller
{
    ...
    public function submitData(Request $request)
    {
        ...
        $ageWiseEbtStudentData = $data["ageWiseEbtStudentData"];
        ...
        /* saving $ageWiseEbtStudentData */

        try {
            Agewise_student_summary::wherein('class_id', array(2000,2001,2002,2003,2004,2005))->where('institute_id', $instId)->delete();
            Agewise_student_summary::insert($ageWiseEbtStudentData);
        } catch (\Exception $e) {
            array_push($err, $e);
        }
        ...
        try {
            Agewise_student_summary::wherein('class_id', array(2106,2107,2108,2109,2110))->where('institute_id', $instId)->delete();
        ...
        try {
            Agewise_student_summary::wherein('class_id', array(2211,2212,2313,2314,2315,2316,2317,2318,2319,2415,2416,2518))->where('institute_id', $instId)->delete();

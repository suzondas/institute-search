...
class PublicStdThirdPageController extends Controller
{
    ...
    public function submitData(Request $request)
    {
        ...
        $instId = $data["instId"];
        $univ_degree_wise_std_hnrs_pass = $data["univ_degree_wise_std_hnrs_pass"];
        $univ_degree_wise_std_hnrs_som = $data["univ_degree_wise_std_hnrs_som"];
        $univ_degree_wise_std_hnrs_tec = $data["univ_degree_wise_std_hnrs_tec"];
        $univ_degree_wise_std_mas = $data["univ_degree_wise_std_mas"];
        $univ_degree_wise_std_mas_tec = $data["univ_degree_wise_std_mas_tec"];
        $univ_degree_wise_std_phd = $data["univ_degree_wise_std_phd"];
        $univ_degree_wise_std_diploma = $data["univ_degree_wise_std_diploma"];

        /*saving data Univ_degree_wise_stds hnrs pass*/
        try {
            Univ_degree_wise_stds::where('institute_id', $instId)->where(['degree_id'=>1])->delete();
            Univ_degree_wise_stds::insert($univ_degree_wise_std_hnrs_pass);
        } catch (\Exception $e) {
            array_push($err, $e);
        }

        /*saving data Univ_degree_wise_stds hnrs somman*/
        try {
            Univ_degree_wise_stds::where('institute_id', $instId)->where(['degree_id'=>2])->delete();
            Univ_degree_wise_stds::insert($univ_degree_wise_std_hnrs_som);
        } catch (\Exception $e) {
            array_push($err, $e);
        }

        /*saving data Univ_degree_wise_stds hnrs tec*/
        try {
            Univ_degree_wise_stds::where('institute_id', $instId)->where(['degree_id'=>3])->delete();
            Univ_degree_wise_stds::insert($univ_degree_wise_std_hnrs_tec);
        } catch (\Exception $e) {
            array_push($err, $e);
        }

        /*saving data Univ_degree_wise_stds masters*/
        try {
            Univ_degree_wise_stds::where('institute_id', $instId)->where(['degree_id'=>4])->delete();
            Univ_degree_wise_stds::insert($univ_degree_wise_std_mas);
        } catch (\Exception $e) {
            array_push($err, $e);
        }

        /*saving data Univ_degree_wise_stds mas tec*/
        try {
            Univ_degree_wise_stds::where('institute_id', $instId)->where(['degree_id'=>5])->delete();
            Univ_degree_wise_stds::insert($univ_degree_wise_std_mas_tec);
        } catch (\Exception $e) {
            array_push($err, $e);
        }

        /*saving data Univ_degree_wise_stds phd*/
        try {
            Univ_degree_wise_stds::where('institute_id', $instId)->where(['degree_id'=>6])->delete();
            Univ_degree_wise_stds::insert($univ_degree_wise_std_phd);
        } catch (\Exception $e) {
            array_push($err, $e);
        }

        /*saving data Univ_degree_wise_stds diploma*/
        try {
            Univ_degree_wise_stds::where('institute_id', $instId)->where(['degree_id'=>7])->delete();
            Univ_degree_wise_stds::insert($univ_degree_wise_std_diploma);
        } catch (\Exception $e) {
            array_push($err, $e);
        }

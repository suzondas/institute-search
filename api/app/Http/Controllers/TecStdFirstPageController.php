...
class TecStdFirstPageController extends Controller
{
    ...
    public function submitData(Request $request)
    {
        ...
        $one_yr_certificate = $data["one_yr_certificate"];
        $one_yr_adv_certificate = $data["one_yr_adv_certificate"];
        ...
        /* saving one_yr_certificate */
        try {
            One_yr_certificate::where('institute_id', $instId)->delete();
            One_yr_certificate::insert($one_yr_certificate);
        } catch (\Exception $e) {
            array_push($err, $e);
        }

        /* saving one_yr_adv_certificate */
        try {
            One_yr_adv_certificate::where('institute_id', $instId)->delete();
            One_yr_adv_certificate::insert($one_yr_adv_certificate);
        } catch (\Exception $e) {
            array_push($err, $e);
        }

        /*saving data of studentSummaryRepeater */
        try {
        ...
        /*saving data of Student_summary_dropout */
        try {

...
class PrivateComFirstPageController extends Controller
{
    ...
    public function index($inst_id)
    {
        ...
        if (empty($foreign_univ_institutes)) {
    ...
    public function store(Request $request)
    {
        ...
        try {
            Institutes::where('institute_id', $instId)->update([
                ...
                'uni_committee_type' => $institutes['uni_committee_type'],
                'uni_member_total' => $institutes['uni_member_total'],
                'uni_member_female' => $institutes['uni_member_female']
            ]);
        } catch (\Exception $e) {
            array_push($err, $e);
        }

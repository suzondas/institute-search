...
class CreateDipCommerceStdSummariesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dip_commerce_std_summaries', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('dip_commerce_std_summaries');
    }
}

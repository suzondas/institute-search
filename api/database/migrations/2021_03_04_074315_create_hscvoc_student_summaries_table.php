...
class CreateHscvocStudentSummariesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hscvoc_student_summaries', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('hscvoc_student_summaries');
    }
}

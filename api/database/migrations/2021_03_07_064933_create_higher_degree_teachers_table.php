...
class CreateHigherDegreeTeachersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('higher_degree_teachers', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('higher_degree_teachers');
    }
}

...
class CreateDiplomaAgriKrishisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('diploma_agri_krishis', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('diploma_agri_krishis');
    }
}

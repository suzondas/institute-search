...
class CreateDiplomaEngineersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('diploma_engineers', function (Blueprint $table) {
            $table->id();
            $table->string('INSTITUTE_ID',15)->unsigned();
            $table->foreign('INSTITUTE_ID')->references('INSTITUTE_ID')->on('INSTITUTES');
            $table->string('EDUCATION_LEVEL_ID',3);
            ...
            $table->integer('GOVT_MALE_STIPEND',3)->nullable();
            $table->integer('GOVT_FEMALE_STIPEND',3)->nullable();
            $table->integer('PR_MALE_STIPEND',3)->nullable();
            $table->integer('PR_FEMALE_STIPEND',3)->nullable();
            $table->integer('GPR_MALE_STIPEND',3)->nullable();
            $table->integer('GPR_FEMALE_STIPEND',3)->nullable();
    ...
    {
        Schema::dropIfExists('diploma_engineers');
    }
}

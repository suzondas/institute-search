...
class CreateStudentSummaryDropoutsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('student_summary_dropouts', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('student_summary_dropouts');
    }
}

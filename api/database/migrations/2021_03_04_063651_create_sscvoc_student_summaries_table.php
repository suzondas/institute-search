...
class CreateSscvocStudentSummariesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sscvoc_student_summaries', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sscvoc_student_summaries');
    }
}

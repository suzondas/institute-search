...
class CreateCategorywiseDisablesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('categorywise_disables', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('categorywise_disables');
    }
}

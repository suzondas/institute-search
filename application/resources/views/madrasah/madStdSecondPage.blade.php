    ...
    <div class="container-fluid" data-ng-app="madStdSecondPage" ng-controller="myCtrl">
            ...
            <div class="contentBoxBody">
                <table class="table table-sm table-bordered table-striped text-center">
                    <tr>
                        ...
                        <td rowspan="2">২০২৩ এর পাঠ্যপুস্তকের চাহিদা অনুযায়ী শিক্ষার্থীর সংখ্যা</td>
                    </tr>
                    <tr>
                        <td>মোট</td>
                        <td>ছাত্রী</td>
        ...
        <div class="contentBox">
            <div class="input-group contentdeader">
                ...
                <div class="form-control bg-number-label">দাখিল ভোকেশনাল এর শ্রেণিভিত্তিক শিক্ষার্থী তথ্য ২০২০
                </div>
            </div>
            <div class="contentBoxBody">
                <table class="table table-sm table-bordered table-striped text-center">
                    ...
                    <tbody>
                    <tr  ng-repeat="item in data.dakhilVocStudentData">
                        <td ng-bind="sscVocName(item.class_id)"></td>
                        <td><input type="number" number-converter class="w-50" ng-model="item.total_student"></td>
                        <td><input type="number" number-converter class="w-50" ng-model="item.female_student"></td>
                        <td><input type="number" number-converter class="w-50"ng-model="item.male_stipend"></td>
        ...
        {{--<div class="contentBox">--}}
            {{--<div class="input-group contentdeader">--}}
                ...
                {{--</div>--}}
                {{--<div class="form-control bg-number-label">আলিম ভোকেশনাল এর বর্ষভিত্তিক শিক্ষার্থী তথ্য ২০২০</div>--}}
            {{--</div>--}}
            {{--<div class="contentBoxBody">--}}
                {{--<table class="table table-sm table-bordered table-striped text-center">--}}
                    {{--<tr>--}}
                    ...
                    {{--</tr>--}}
                    {{--<tbody>--}}
                    {{--<tr ng-repeat="item in data.alimVocStudentData">--}}
                        {{--<td ng-bind="hscVocName(item.class_id)"></td>--}}
                        {{--<td><input type="number" number-converter class="w-50" ng-model="item.total_student"></td>--}}
                        {{--<td><input type="number" number-converter class="w-50" ng-model="item.female_student"></td>--}}
                        {{--<td><input type="number" number-converter class="w-50"ng-model="item.male_stipend"></td>--}}

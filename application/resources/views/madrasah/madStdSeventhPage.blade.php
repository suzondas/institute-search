...
@section('content')
    ...
    <div class="container-fluid" id="madStdSeventhPage">
        <div v-if="!dataLoaded">
        ...
        <div v-if="dataLoaded">
            ...
            <div class="contentBox ">
                ...
                <div class="col-md-6">
                    <label class="label-number font-weight-bold">২.৩১.১ সংযু্ক্ত এসএসসি (ভোকেশনাল)/এইচএসসি (বিএম) শাখার
            ...
            <div class="row  contentBox">
                ...
                <div class="col-md-4 contentBoxBody">
                    ...
                    <label class="font-weight-bold"> ২.৩২.১ মূল প্রতিষ্ঠানের সার্বোচ্চ শিক্ষাগত যোগ্যতাভিত্তিক শিক্ষক
                        সংখ্যা:</label>
                ...
                <div class="col-md-4 contentBoxBody">
                    <label class="font-weight-bold">২.৩২.২ মূল প্রতিষ্ঠানের সর্বোচ্চ পেশাগত ডিগ্রিপ্রাপ্ত শিক্ষক
                        সংখ্যা:</label>
                ...
                <div class="col-md-4 contentBoxBody">
                    <label class="font-weight-bold"> ২.৩২.৩ মূল প্রতিষ্ঠানের আইসিটি বিষয়ক প্রশিক্ষণ/ ডিগ্রি প্রাপ্ত
                        শিক্ষক
                        সংখ্যা: </label>
            ...
            <div class="contentBox">
                ...
                <div class="contentBoxBody">
                    <label class="font-weight-bold">২.৩৩.১ সৃজনশীল প্রশ্নপত্র প্রণয়ন ও উত্তরপত্র মূল্যায়ন
                    ...
                    <table class="table table-bordered table-striped">
                        <tr>
                            <td><label class="font-weight-bold">২.৩৩.২ বিশেষ চাহিদাসম্পন্ন শিক্ষক এর কর্মকালীন
                            ...
                            <td><label class="font-weight-bold">২.৩৩.৩ ক্ষুদ্র-নৃ-গোষ্ঠী শিক্ষক এর কর্মকালীন প্রশিক্ষণের
                                    তথ্য (সংখ্যা
                                    লিখুন)</label><br>
                                মোট: <input type="number" class="w-25"
                                ...
                                মহিলা: <input type="number" class="w-25"
                                              ...
                                              :maxlength="5"/></td>
                            <td class="form-inline"><label class="font-weight-bold">২.৩৩.৪ বিশেষ চাহিদাসম্পন্ন
                        ...
                        <tr>
                            <td class="form-inline"><label class="font-weight-bold">২.৩৩.৫ দুর্যোগ ব্যবস্থাপনা সংক্রান্ত
                                    প্রশিক্ষণপ্রাপ্ত শিক্ষক আছে কি? </label><br>
                                <select class="w-25" v-model="data.teacherTrainInfo.disaster_train_teacher_yn">
                                    <option value="1"> হ্যাঁ</option>
                                    <option value="2"> না</option>
                                </select></td>
                            <td><label class="font-weight-bold">২.৩৩.৬ উত্তর হ্যাঁ হলে কয়জন?</label><br>
                    ...
                    <table class="table table-bordered table-striped ">
                        <tr>
                            <td colspan="4" class="font-weight-bold">২.৩৩.৭ শিক্ষকদের কোন কোন বিষয়ে প্রশিক্ষণ প্রয়োজন?
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="col-md-6 mt-2">
                    <div class="col">
                        <table class="table table-sm table-bordered table-striped text-center">
                            ...
                            <tbody>
                            <tr>
                                <td style="width: 350px" class="font-weight-bold">২.৩৫.১ ক্লাস রুটিন অনুযায়ী ইংরেজি
                    ...
                    <div class="col"><label class="font-weight-bold"> ২.৩৫.২ ইংরেজি বিষয়ে পাঠদানকারী শিক্ষকের স্নাতক
                ...
                <div class="col-md-6 mt-2">
                    <div class="col">
                        <table class="table table-sm table-bordered  table-striped text-center">
                            ...
                            <tbody>
                            <tr>
                                <td style="width: 350px" class="font-weight-bold">২.৩৫.৩ ক্লাস রুটিন অনুযায়ী গণিত বিষয়ে
                                    পাঠদানকারী শিক্ষক সংখ্যা:
                                </td>
                                <td><input type="number" class="w-50"
                    ...
                    <div class="col">
                        <label class="font-weight-bold">২.৩৫.৪ গণিত বিষয়ে পাঠদানকারী শিক্ষকের স্নাতক (পাস), স্নাতক
            ...
            <div class="row contentBox">
                ...
                <div class="col-md-6">
                    {{--teacherRetAwInfo Table--}}
                    <label class="font-weight-bold"> ২.৩৭.১ শিক্ষা প্রতিষ্ঠানে প্রাপ্ত পুরষ্কার সম্পর্কিত তথ্য
                ...
                <br>
                <div class="col-md-6">
                    <label class="font-weight-bold"> ২.৩৭.২ বিভিন্ন পর্যায়ে অংশগ্রহণকারী ও পুরষ্কারপ্রাপ্ত শিক্ষার্থী
                        সংখ্যা</label>
                    <table class="table table-sm table-bordered text-center">
                        <tbody>
                        <tr class="custom-table-header">

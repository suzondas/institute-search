...
@section('content')
    <div class="container-fluid" style="font-size:13px !important;" id="secondPage">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <table class="table table-sm table-striped table-bordered">
                                ...
                                <tr>
                                    <td>
                                        ১.৬.৬ প্রতিষ্ঠানটির অবকাঠামোগত অবস্থান:
                                    </td>
                                    <td>
                    ...
                    <div class="table-bordered">
                        ...
                        <table class="table table-sm table-striped table-bordered text-center">
                            <tr class="custom-table-header">
                                ...
                                <td>বিশেষ চাহিদা সম্পন্ন শিক্ষার্থীর রুম</td>
                                <td>কাউন্সিলিং রুম</td>
                                <td>শিক্ষা উপকরণ সংরক্ষণের জন্য রুম</td>
                                <td>অন্যান্য</td>
                            </tr>
                            <tbody>
                            <tr>
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-sm table-striped table-bordered text-center">
                                ...
                                <tr v-for="item in data.classwise_room_space">
                                    <td class="text-left">@{{ item.education_level_name_bangla }}</td>
                                    <td class="text-left">@{{ item.class_name_bangla }}</td>
...
@endsection
@section('javascript')
    <script src="{{ asset('js/secondPage.js') }}" type="module"></script>
@stop

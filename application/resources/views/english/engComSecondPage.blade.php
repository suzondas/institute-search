...
@section('content')
    <div class="container" style="font-size:13px !important;" id="engComSecondPage">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <table class="table table-sm table-striped table-bordered">
                                <tr>
                                    <td>
                                        ১.৬.১ প্রতিষ্ঠানের সবচেয়ে পুরাতন ভবনটি নির্মাণের বছর</td>
                                    <td>
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table table-sm table-striped table-bordered text-center">
                                ...
                                <tr v-for="(item,index) in data.building_details">
                                    <td>@{{index+1}}</td>
                                    <td><input type="text" class="w-100" name="" v-model="item.building_name">
                                    </td>
                    ...
                    <div class="table-bordered">
                        <table class="table table-sm table-striped table-bordered text-center">
                            ...
                            <tr>
                                ...
                                <td><input type="number" class="w-75" name="" id="" style=""></td>
                                <td><input type="number" class="w-75" name="" id="" style=""
                        ...
                        <table class="table table-sm table-striped table-bordered text-center">
                            <tr class="custom-table-header">
                                ...
                                <td>ছাত্রাবাসে অবস্থানকারী</td>
                                <td>ছাত্রীনিবাসের সিট সংখ্যা</td>
                                <td>ছাত্রীনিবাসে অবস্থানকারী</td>
                            ...
                            <tr>
                                ...
                                <td><input type="number" class="w-75" name=""></td>
                                <td><input type="number" class="w-75" name=""
                        ...
                        <table class="table table-sm table-bordered table-striped">
                            <tr>
                                <td>
                                    ...
                                    <input type="checkbox" true-value="1" false-value="0" class="form-control"  v-model="data.building_use.mosjid"
                                           style="width: 20px">
                                </td>
                                <td>
                                    <label class="label-number" for="">নামাজ ঘর</label>
                                    <input type="checkbox" true-value="1" false-value="0" class="form-control" v-model="data.building_use.prayer_room"
                                           style="width: 20px">
                                </td>
                                <td>
                                    <label class="label-number" for="">মন্দির</label>
                                    <input type="checkbox" true-value="1" false-value="0" class="form-control" v-model="data.building_use.mondir"
                                           style="width: 20px">
                                </td>
                                <td>
                                    <label class="label-number" for="">গীর্জা</label>
                                    <input type="checkbox" true-value="1" false-value="0" class="form-control"  v-model="data.building_use.girja"
                                           style="width: 20px">
                                </td>
                                <td>
                                    <label class="label-number" for="">প্যাগোডা</label>
                                    <input type="checkbox" true-value="1" false-value="0" class="form-control" v-model="data.building_use.pagoda"
                                           style="width: 20px">
                                </td>
                                <td>
                                    <label class="label-number" for="">অন্যান্য</label>
                                    <input type="checkbox" true-value="1" false-value="0" class="form-control" v-model="data.building_use.other_religious_place"
                                           style="width: 20px">
                                </td>
                            </tr>
                        </table>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <table class="table table-sm table-striped table-bordered text-center">
                                <tr class="custom-table-header">
                                    <td>শ্রেণি/পর্ব</td>
                                    <td colspan="3">কক্ষ সংখ্যা</td>
                                    <td colspan="3">কক্ষের আয়তন (বর্গফুট)</td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>পাকা</td>
                                ...
                                <tr v-for="item in data.classwise_room_space">
                                    <td style="text-align: left">@{{ className(item.class_id) }}</td>
                                    <td><input type="number" class="w-50" v-model="item.packa"></td>
                                    <td><input type="number" class="w-50" v-model="item.semi_packa"></td>
                                    <td><input type="number" class="w-50" v-model="item.kancha"></td>
                                    <td><input type="number" class="w-50" v-model="item.packa_sft"></td>
                                    <td><input type="number" class="w-50" v-model="item.semi_packa_sft"></td>
                                    <td><input type="number" class="w-50" v-model="item.kancha_sft"></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
...
@endsection
@section('javascript')
    <script src="{{ asset('js/engComSecondPage.js') }}" type="module" defer></script>
@stop

...
const app = new Vue({
    ...
    methods: {
        ...
        submitData: function () {
            ...
            // return;
            axios.post(apiServer+'/publicComFirstPage/submitData', dataToSend)
                .then(
                    function (response) {
        ...
        addMoreForeignUniv: function () {
            ...
            axios.post(apiServer+'/publicComFirstPage/addForeignUnivInst/', toSend)
                .then(
                    function (response) {
        ...
        deleteForeignUniv: function (id, index) {
            ...
            var self = this;
            axios.get(apiServer+'/publicComFirstPage/removeForeignUnivInst/' + id)
                .then(
                    function (response) {

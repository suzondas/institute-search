const app = new Vue({
    ...
    mounted() {
        var self = this;
        axios.get(apiServer+'/madFirstPage/' + inst_id)
    ...
    methods: {
        ...
        submitData: function () {
            ...
            dataToSend.inst_mpo_conditions=this.data.inst_mpo_conditions;
            console.log(dataToSend);
            // return;
            axios.post(apiServer+'/madFirstPage/submitData', dataToSend)
                .then(
                    function (response) {

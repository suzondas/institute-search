...
const app = new Vue({
    ...
    methods: {
        ...
        submitData: function () {
            ...
            // return;
            axios.post(apiServer+'/publicTeachSecondPage/submitData', dataToSend)
                .then(
                    function (response) {
        ...
        addMoreReshTeach: function () {
            ...
            axios.post(apiServer+'/publicTeachSecondPage/addReshTeacher', toSend)
                .then(
                    function (response) {
        ...
        deleteReshTeach: function (id, index) {
            ...
            var self = this;
            axios.get(apiServer+'/publicTeachSecondPage/removeReshTeacher/' + id)
                .then(
                    function (response) {

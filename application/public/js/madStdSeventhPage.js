const app = new Vue({
    ...
    mounted() {
        var self = this;
        axios.get(apiServer + '/madStdSeventhPage/' + inst_id)
    ...
    methods: {
        ...
        validate:function(){
            ...
            if(this.teachers_in_service ===0){
                this.errorMessage.push("২.৩১ এর কর্মরত মোট সংখ্যা 0 হতে পারে না।")
            }
            if(this.female_teachers_in_service>this.teachers_in_service){
                this.errorMessage.push("২.৩১ এর কর্মরত মহিলা সংখ্যা থেকে কর্মরত মোট সংখ্যা কম হতে পারে না।")
            }
        },
        ...
        submitData: function () {
            ...
            dataToSend.teachVocStafSum = self.data.teachVocStafSum;
            ...
            dataToSend.teacherInservTr = self.data.teacherInservTr;
            dataToSend.teacherTrainInfo = self.data.teacherTrainInfo;
            dataToSend.teacherRetAwInfo = self.data.teacherRetAwInfo;
            console.log(dataToSend);
            axios.post(apiServer + '/madStdSeventhPage/submitData', dataToSend)
                .then(
                    function (response) {
